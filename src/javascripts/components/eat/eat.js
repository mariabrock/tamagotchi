...
const loadEat = () => {
  ...
  domString += '<button id="carrot" type="button">Carrot<i class="fa fa-carrot fa-2x"></i></button>';
  domString += '<button id="cookie" type="button">Cookie<i class="fa fa-cookie fa-2x"></i></button>';
